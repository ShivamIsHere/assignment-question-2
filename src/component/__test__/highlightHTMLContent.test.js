...
// Test with a valid highlight position that starts and ends within the content
test("Test with a valid highlight position within content", () => {
  ...
  // Test with a valid highlight position that starts at the beginning of the content
  ...
  // Test with a valid highlight position that ends at the end of the content
  ...
  // Test with an invalid highlight position where end is before start
  ...
  // Test with an invalid highlight position that is out of bounds of the content length
